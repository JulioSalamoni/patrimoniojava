	...
	public String cadastrar(Usuarios obj) {
		...
		try {
			if(abrir()) {
				...
				//insert do mysql. nós precisamos executar um
				//comando na camada de aplicação.
				...
				//para cada campo da tabela há um ponto de interrogação correspondente
				//Esta é uma consulta parametrizada. uma das formas de evitar a injeção de SQL(SQLInjection)
